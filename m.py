...
TOKEN = '7190033255:AAGCDt7Da-O_Gpxa0uGwHg5UiRxu7XbHQZs'
...
FORWARD_CHANNEL_ID = -1002189074551
CHANNEL_ID = -1002189074551
error_channel_id = -1002189074551

# Add your admin user IDs here
ADMIN_USER_IDS = [5926683326] 
...
def send_welcome(message):
    ...
    btn5 = KeyboardButton("Price💸")
    btn6 = KeyboardButton("Contact admin✔️")
    btn7 = KeyboardButton("STOP")
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://apkpure.net/httpcanary-%E2%80%94-http-sniffer-capture-analysis/com.guoshi.httpcanary/download/3.3.2", parse_mode='Markdown')
        ...
        if user_data:
            ...
            response = "*No account information found. Please contact @unusual074.*"
        bot.reply_to(message, response, parse_mode='Markdown')
    elif message.text == "Price💸":
        bot.reply_to(message, "*INSTANT 🔥- day 110 , week 550 , month 1999                                                       INSTANT++ 🔥🔥-  day 150 , week 750 , month 2799*", parse_mode='Markdown')
    elif message.text == "Contact admin✔️":
        bot.reply_to(message, "*@unusual074*", parse_mode='Markdown')
